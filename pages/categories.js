            ...
            <div className="flex flex-col place-items-center gap-1 h-full">
                <div className="bg-slate-700 rounded-xl mt-20 shadow-lg shadow-slate-900 h-5/6 w-2/3">
                    <div className='flex flex-col place-items-center'>
                        ...
                        {!editedCategory && (
                            <div class="w-3/4 overflow-x-auto shadow-md sm:rounded-lg flex place-content-center border border-amber-400">
                                <table className="min-w-full w-full text-sm text-left text-gray-500 dark:text-gray-700">
